      ...
      <input type="submit" name="submit" value="Submit" /> 
            ...
            <?php  
              ...
              switch ($_POST["type"]) {
                case 'seal':
                  # code...
                $query_seal = "select * from seal where userid = '$id' and sdate >= '{$_POST['start_datetime']}' and sdate <= '{$_POST['end_datetime']}' order by sdate desc";
                 ...
                 while($rows = mysqli_fetch_array($result_seal))
            {
                ...
                mysqli_close($link);
                  ...
                  break;
                   ...
                   case 'meeting':
                  # code...
                  $query_meeting = "select * from meetingroom where meetingstarterid = '$id' and meetingdate >= '{$_POST['start_datetime']}' and meetingdate <= '{$_POST['end_datetime']}' ";
                   ...
                   while($rowm = mysqli_fetch_array($result_meeting))
            {
                ...
                mysqli_close($link);
                  break;
                   ...
                   case 'holiday':
                  # code...
                    $query_holiday = "select * from holiday where starterid = '$id' and starttime >= '{$_POST['start_datetime']}' and starttime <= '{$_POST['end_datetime']}' order by starttime desc";
