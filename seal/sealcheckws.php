...
if (!$link){
    echo"alert('数据库连接失败！')";
        ...
        $row = mysqli_fetch_array($result);
          ...
          $query= "UPDATE seal SET ifs = '{$answer}',suggestion ='{$_GET['suggestion']}' WHERE sealid = '{$_GET['sealid']}' "; 
       ...
       sendstarter($link,$accesstoken,$link,$row['starter'],"印章",$name,$row['type'],$_GET['decision'],$_GET['suggestion'],"");
     }else{
