...
if (!$link){
    echo"alert('数据库连接失败！')";
        ...
        $query = "select * from seal where sealid = '{$sealid}' ";
...
?>
<form action="sealcheck2.php" method="post">
  
   <?php
   echo " <input type='text' name='sealid' style='display:none' value='{$sealid}'> ";
   ...
   <!-- 建议：
    ...
    <h4>上报：</h4>
            <h4><select  name="leader" id="select_leader3">
               
                <option value="blank" selected="selected">名单</option>
                <option value="王长伟">王长伟</option>
                <option value="孙连鹏">孙连鹏</option>
