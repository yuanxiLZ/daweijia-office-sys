...
if (!$link){
    echo"alert('数据库连接失败！')";
       ...
       $row = mysqli_fetch_array($result)
          ...
          echo "<h4>会议名称:&nbsp&nbsp".$row['meetingcontent'] ."</h4>";
          echo "<h4>会议地点:&nbsp&nbsp".$row['meetingroom'] ."</h4>";
          echo "<h4>会议时间:&nbsp&nbsp".$row['meetingdate'] .$row['meetingstart']."</h4>";
          echo "<h4>参会人员:&nbsp&nbsp".$row['meetingmember'] ."</h4>";
          echo "<h4>备注:&nbsp&nbsp".$row['meetingremark'] ."</h4>";
