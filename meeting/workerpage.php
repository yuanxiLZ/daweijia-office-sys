<?php
 ...
 include("../sqlconnect.php"); 
  ...
  session_start();
      ...
      // if ($LV==2) {
      //   header('Location:workerpage2.php');
      //   //$_SESSION['sealid']=$_GET['sealid'];
      // }
      if ($position!="会议室管理") {
         header('Location:checkmeeting.php');
      }
           switch ($LV)
{
case 2:
...
if (!$link){
    echo"alert('数据库连接失败！')";
        ...
        $query = "select * from meetingroom where meetingoffice = '1' order by meetingdate asc,meetingstart asc";
